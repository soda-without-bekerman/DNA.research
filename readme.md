...
Полный набор ДНК человека ~ 455 экзабайт (100 млрд DVD-дисков). ~1 млрд гбайт
...
|   28.04.14    |  **◕**       |**Приготовить/Скомпоновать текст/картинки**|
|   26.04.14    |  **◕**       |**`readme > faq > DNA.github.io`**      |
